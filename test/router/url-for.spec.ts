...
describe('urlFor', () => {
  ...
  describe('urlForName method', () => {
    ...
    it('should exist', () => {
      expect(router).to.have.property('urlForName').which.is.a('function');
    });
    ...
    it('should drop extra path delimeters', async () => {
      await router.setRoutes([
        {
          name: 'root',
          path: '/',
    ...
    it('should not throw for children function', async () => {
      await router.setRoutes([{ name: 'root', path: '/', component: 'x-root', children: () => [] }]);
    ...
    it('should allow setting new routes with old names', async () => {
      // Warm up the cache
      expect(router.urlForName('app')).to.equal('/app');
      expect(router.urlForName('home')).to.equal('/app/home');
      expect(router.urlForName('x-user-list')).to.equal('/app/users');
    ...
    it('should throw for route name duplicating route name', async () => {
      await router.setRoutes([
    ...
    it('should throw for component name duplicating route name', async () => {
      await router.setRoutes([
    ...
    it('should throw for route name duplicating component name', async () => {
      await router.setRoutes([
        { path: '/', component: 'x-foo' },
    ...
    it('should throw for component name duplicating component name', async () => {
      await router.setRoutes([
        { path: '/', component: 'x-foo' },
        { path: '/', component: 'x-foo' },
        { path: '/', component: 'x-unique' },
    ...
    it('should not use component name when name is assigned', async () => {
      await router.setRoutes([{ name: 'foo', path: '/', component: 'x-foo' }]);
  ...
  describe('urlForPath method', () => {
    it('should exist', () => {
      expect(router).to.have.property('urlForPath').which.is.a('function');
    });
